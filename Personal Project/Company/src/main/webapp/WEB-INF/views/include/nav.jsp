...
<body>
	...
	<header class="navbar navbar-expand-lg fixed-top" style="background: white; border-bottom: 1px solid #DADCE0;">
		<div class="container">
			...
			<a class="btn btn-primary btn-sm fs-sm order-lg-3 d-none d-sm-inline-flex" href="<%=request.getContextPath()%>/common/loginPage.do" style="margin-right: 1em;">
				로그인
			</a>
			<a class="btn btn-primary btn-sm fs-sm order-lg-3 d-none d-sm-inline-flex" href="<%=request.getContextPath()%>/common/signinPage.do">
				회원가입
			</a>
