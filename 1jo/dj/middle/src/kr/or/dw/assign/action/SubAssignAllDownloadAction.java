...
public class SubAssignAllDownloadAction implements IAction{
	...
	public String process(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		assign_pathList = service.getAllAssignPath(assign_no);
		
		for(String ap : assign_pathList) {
			String assign_path = ap;
