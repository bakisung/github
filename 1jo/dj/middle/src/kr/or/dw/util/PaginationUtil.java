...
public class PaginationUtil {
	...
	public void setConfig(int page, int countList, int countPage, int totalCount) {
		 ...
		 * countList : 한 페이지 당 레코드 수    (기본 10)
		 * countPage : 페이지의 리스트에서 보여줄 페이지 갯수 (보통 5나 10)
		...
		int startPage = ((page - 1) / countPage) * countPage + 1; //페이지에 -1을 뺴고 마지막 결과에 +1을 하는것은 1과 10 페이지의 문제 때문이다.
