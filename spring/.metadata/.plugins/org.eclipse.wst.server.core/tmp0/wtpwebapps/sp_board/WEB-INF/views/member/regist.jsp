    					...
    					<form role="form" class="form-horizontal" action="regist.do" method="post">
    							...
    							<div class="mailbox-attachments clearfix" style="text-align: center;">
									...
									<div class="mailbox-attachment-info">
										<div class="input-group input-group-sm">
											<label for="inputFile" class="btn btn-warning btn-sm btn-flat input-group-addon">파일 선택</label>
    						...
    						<div class="form-group row">
    							<label for="authority" class="col-sm-3" style="font-size: 0.9em;">권 한</label>
   								<div class="col-sm-9 input-group-sm">
									<select name="authority" class="form-control" style=" 0.9em;">
    						...
    						<div class="card-footer">
    							<div class="row">
    								<div class="col-sm-6">
    									<button type="button" id="registBtn" class="btn btn-primary" onclick="">가입하기</button>
    								</div>
    								<div class="col-sm-6">
    									<button type="button" id="cencelBtn" class="btn btn-danger float-right" 
    										onclick="CloseWindow();">&nbsp;&nbsp;&nbsp;취&nbsp;&nbsp;소&nbsp;&nbsp;&nbsp;
    									</button>
    								</div>
    							</div>
    						</div>
