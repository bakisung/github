...
public class SampleClass {
	...
	void flowTest1() {
		...
		flowTest3();	// 같은 클래스의 메소드를 호출할 때는 이렇게 호출한다.
		System.out.println("flowTest1 종료 : 3");
	}
	void flowTest2() {
		System.out.println("flowTest2 시작 : 3");
		System.out.println("flowTest2 종료 : 1");
	}
	void flowTest3() {
		System.out.println("flowTest3 시작 : 2");
		flowTest2();
		System.out.println("flowTest3 종료 : 2");
	}
