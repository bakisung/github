 ...
 * Generated at: 2023-05-25 02:08:06 UTC
...
public final class boardInsert_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(request.getAttribute("boardVo") != null){
      ...
      out.write("\t\t\t\t\t\t<h3 class=\"card-title\">글작성</h3>\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/board/contentInsert.do\">\r\n");
      out.write("\t\t\t\t\t\t");
 if(boardVo != null){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"bd_no\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" id=\"inputName\" name=\"title\" class=\"form-control\" required value=\"");
      out.print(boardVo != null ? boardVo.getBd_title() : "");
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"inputDescription\">내용</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<textarea id=\"inputDescription\" name=\"content\" class=\"form-control\" rows=\"4\">");
      out.print(boardVo != null ? boardVo.getBd_content() : "");
      out.write("</textarea>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-success btn-sm\">");
      out.print( boardVo != null ? "수정" : "등록" );
      out.write("</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t<button class=\"btn btn-default btn-sm\" onclick=\"history.go(-1)\">취소</button>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
