 ...
 * Generated at: 2023-05-25 01:32:25 UTC
...
public final class joinForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t$(function(){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tn_check = false;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$('#joinForm').on('submit', function(e){\r\n");
      out.write("\t\t\tif($('#joinForm').find('.is-invalid').length > 0){\r\n");
      out.write("\t\t\t\talert(\"형식에 맞게 입력해주세요.\");\r\n");
      out.write("\t\t\t\t$('#joinForm').find('.is-invalid').focus();\r\n");
      out.write("\t\t\t\te.preventDefault();\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t};\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(n_check == false){\r\n");
      out.write("\t\t\t\talert(\"닉네임 중복확인 체크를 해주세요.\");\r\n");
      out.write("\t\t\t\t$('input[name=nick]').focus();\r\n");
      out.write("\t\t\t\te.preventDefault();\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t};\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// email 정규식 체크\r\n");
      out.write("\t\tlet email = $('input[name=email]');\r\n");
      out.write("\t\temail.on('keyup', function(){\r\n");
      out.write("\t\t\tlet emailVal = email.val().trim();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tregEmail = /^[0-9a-zA-Z]([-_\\.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_\\.]?[0-9a-zA-Z])*\\.[a-zA-Z]{2,3}$/;\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif( !(regEmail.test(emailVal)) ){\r\n");
      out.write("\t\t\t\temail.attr('class', 'form-control is-invalid');\t\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\temail.attr('class', 'form-control is-valid');\r\n");
      out.write("\t\t\t};\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// password 정규식 체크 - 영문 소문자, 대문자, 특수문자, 숫자가 반드시 하나 이상씩 입력\r\n");
      out.write("\t\tlet pass = $('input[name=pass]');\r\n");
      out.write("\t\tpass.on('keyup', function(){\r\n");
      out.write("\t\t\tpassVal = pass.val().trim();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tregPass = /^(?=.*[a-z])(?=.*[A-Z])(?=.*[`~!@$%&?*])[A-Za-z\\d`~!@$%&?*]{8,15}/;\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif( !(regPass.test(passVal)) ){\r\n");
      out.write("\t\t\t\tpass.attr('class', 'form-control is-invalid');\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\tpass.attr('class', 'form-control is-valid');\r\n");
      out.write("\t\t\t};\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// pass2 pass일치 비교\r\n");
      out.write("\t\tlet passCheck = $('input[name=passCheck]');\r\n");
      out.write("\t\tpassCheck.on('keyup', function(){\r\n");
      out.write("\t\t\tlet passCheckVal = passCheck.val().trim();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(passVal == passCheckVal){\r\n");
      out.write("\t\t\t\tpassCheck.attr('class', 'form-control is-valid');\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\tpassCheck.attr('class', 'form-control is-invalid');\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tlet nickCheck = false;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// 닉네임 정규식 체크\r\n");
      out.write("\t\tlet nick = $('input[name=nick]');\r\n");
      out.write("\t\tnick.on('keyup', function(){\r\n");
      out.write("\t\t\tnickVal = nick.val().trim();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tregNick = /^[가-힣a-zA-Z0-9]{3,13}$/;\r\n");
      out.write("\t\t\tif( !(regNick.test(nickVal)) ){\r\n");
      out.write("\t\t\t\tnick.attr('class', 'form-control is-invalid');\r\n");
      out.write("\t\t\t\tnickCheck = false;\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\tnick.attr('class', 'form-control is-valid');\r\n");
      ...
      out.write("\t\t\tif(nickCheck){\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl : '");
      out.print( request.getContextPath() );
      out.write("/user/nickCheck.do',\r\n");
      out.write("\t\t\t\t\tmethod : 'post',\r\n");
      out.write("\t\t\t\t\tdata : {'nick' : nickVal},\r\n");
      out.write("\t\t\t\t\tdataType : 'json',\r\n");
      out.write("\t\t\t\t\tsuccess : function(res){\r\n");
      out.write("\t\t\t\t\t\tif(res == '사용가능한 닉네임입니다.'){\r\n");
      out.write("\t\t\t\t\t\t\talert(res);\r\n");
      out.write("\t\t\t\t\t\t\tn_check = true;\r\n");
      out.write("\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\talert(res);\t\t\r\n");
      out.write("\t\t\t\t\t\t\tn_check = false;\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// 생년월일 체크 - 14살 이상\r\n");
      out.write("\t\tlet bir = $('input[name=bir]');\r\n");
      out.write("\t\tbir.on('change', function(){\r\n");
      out.write("\t\t\tlet birVal = bir.val().trim();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tregBir = new Date(birVal);\r\n");
      out.write("\t\t\tnow = new Date();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif((now - regBir) < 0){\r\n");
      out.write("\t\t\t\talert(\"올바른 형식이 아닙니다!\");\r\n");
      out.write("\t\t\t\tbir.attr('class', 'form-control is-invalid');\r\n");
      out.write("\t\t\t\tbir.focus();\r\n");
      out.write("\t\t\t}else if(14 > (now.getFullYear() - regBir.getFullYear()) ){\r\n");
      out.write("\t\t\t\talert(\"14세 이상만 가입 가능합니다!\");\r\n");
      out.write("\t\t\t\tbir.attr('class', 'form-control is-invalid');\r\n");
      out.write("\t\t\t\tbir.focus();\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\tbir.attr('class', 'form-control is-valid');\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t})\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/user/insertUser.do\" id=\"joinForm\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"card-body\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"input-group mb-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group-prepend\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-text\"><i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"fas fa-envelope\"></i></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"email\" class=\"form-control\" placeholder=\"Email\" name=\"email\" required>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"error invalid-feedback\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t이메일 형식을 맞춰서 작성해주세요.\r\n");
      out.write("\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"input-group mb-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group-prepend\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-text\"> <i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"fas fa-solid fa-key\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"password\" class=\"form-control\" placeholder=\"password\" name=\"pass\" required>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"error invalid-feedback\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t비밀번호는 영문 소문자, 대문자, 숫자, 특수문자가 최소 1개씩 입력되어야 합니다.\r\n");
      out.write("\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"input-group mb-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group-prepend\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-text\"> <i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"fas fa-solid fa-check\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"password\" class=\"form-control\" name=\"passCheck\" placeholder=\"check password\" required>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"error invalid-feedback\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t입력하신 비밀번호와 일치하지 않습니다.\r\n");
      out.write("\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"input-group mb-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group-prepend\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-text\"> <i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"fab fa-brands fa-kickstarter-k\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"nickname\" name=\"nick\" required>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"error invalid-feedback\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t닉네임은 특수문자를 제외한 3-13 자리로 입력해주세요.\r\n");
      out.write("\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"input-group-append\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-info btn-flat\" id=\"nickCheckBtn\">중복확인</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"input-group mb-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group-prepend\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-text\"> <i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"fas fa-solid fa-signature\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group-prepend\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-text\"> <i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"fas fa-solid fa-calendar-check\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"date\" class=\"form-control\" placeholder=\"birth\" name=\"bir\" required>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"input-group mb-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group-prepend\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-text\"> <i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"fas fa-solid fa-venus-mars\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"submit\" id=\"submitBtn\" class=\"btn btn-info btn-flat\">Go!</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
