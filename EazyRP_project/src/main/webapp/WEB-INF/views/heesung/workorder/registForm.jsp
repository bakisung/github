...
<body>
    <h2>작업지시서 등록</h2>
	<!-- card footer End -->
<form role="form" method="post" action="<%=request.getContextPath() %>/erp4/workorder/regist.do" enctype="multipart/form-data">
	<table>
        <tr>
        ...
        <tr>
            ...
            <td>
	            ...
	            <input type="text" style="width: 100%;" value="${c_name } / ${ename }" id="name" name="name" readonly onclick="OpenWindow('<%=request.getContextPath() %>/mymenu/findPeople.do', '사람찾기', 400, 600)">
            </td>
        </tr>
        <tr>
