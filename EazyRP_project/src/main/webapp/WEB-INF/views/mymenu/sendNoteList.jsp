			...
			<div class="col-md-10" style="max-width: 1100px;">
				<div class="card card-outline card-info">
					<div class="card-header" style="border-bottom: none;"> 
						...
						<form id="searchForm" method="post" action="<%= request.getContextPath()%>/mymenu/sendNoteList.do?mcode=${mcode }&murl=${murl }" style="display: contents;">
							...
							<table style="font-size: 0.8em;" class="table table-borderd text-center">
								...
								<c:forEach items="${note}" var="note" varStatus="loop">
									<tr>
										...
										<td style="text-align: center;"><a id="aTag" href="#" onclick="OpenWindow('<%= request.getContextPath()%>/mymenu/detail.do?n_no=${note.n_no }&send=Y', '쪽지보기', 700, 1000, '${loop.index}')">${note.title }</a></td>
