...
<form role="form" method="post" action="<%=request.getContextPath()%>/erp4/productSaleRegistForm.do" enctype="multipart/form-data">
	<table>
        ...
        <tr>
            ...
            <td><input type="text" name="pr_name" id="pr_name" style="width: 100%;" placeholder="제목을 입력해주세요." required></td>
        </tr>
    </table>
    ...
    <table>
    	<thead>
        <tr>
            <th align="center" style="width: 22%;">제품코드</th>
        ...
        <tr>
            <td><input type="text" id="0" class="pr_no" name="pr_no" style="width: 100%;" value="" ></td>
...
<script>
	...
	$('#addPutBtn').on('click', function(){
		cnt++;
		$('#prInput').append('<tr>'+
			'<td><input type="text" id="'+ cnt +'"class="pr_no" name="pr_no" style="width: 100%;" value=""></td>'+
           '<td><input type="text" id="quantity" class="quantity" name="quantity" style="width: 100%;" value=""></td>'+
           '<td><input type="text" class="cost" id="cost" style="width: 100%;"></td>'+
           '<td><input type="text" id="amount" name="amount" style="width: 100%;" value="" class="readonly" readonly></td>'+
